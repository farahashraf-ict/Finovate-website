...
export default function Home() {
  ...
  return (
    <div className="pt-20">
      ...
      <section
        ref={heroSectionRef}
        className="pt-20 relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-50 via-white to-cyan-50"
      >
        <div className="relative min-h-screen [perspective:1400px]">
          <div
            className={`relative min-h-screen transition-transform duration-[1000ms] [transform-style:preserve-3d] will-change-transform ${
              isHeroFlipped
          ...
          >
            ...
            >
              <div className="h-full w-full min-h-screen flex flex-col">
                <div className="flex-[3] min-h-[40vh] text-center bg-gradient-to-r from-[#0A1533] to-[#010208] px-6 py-8 sm:py-12 flex flex-col items-center justify-center">
                  <h2 className="text-2xl sm:text-3xl lg:text-5xl font-semibold text-white leading-tight">
                    Powering the Future of Finance with Intelligent Innovation
                  </h2>
                  <p className="mt-4 text-gray-300 text-base sm:text-lg lg:text-xl max-w-2xl">
                    From AI-driven automation to advanced analytics
                  </p>
                  <Link
                    to="/about"
                    className="group mt-6 inline-flex items-center gap-2 bg-white text-[#0A1533] px-6 py-3 rounded-full font-medium transition-all duration-300 hover:bg-gray-200"
                  >
                    Explore More
                ...
                <div className="relative flex-[7] min-h-[60vh]">
                  <video
                    autoPlay
                    loop
                    muted
