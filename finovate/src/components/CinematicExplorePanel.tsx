...
const timelineRef = useRef<gsap.core.Timeline | null>(null);
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set(letters, {
        ...
        filter: "blur(14px)",
        scale: 1.7,
        x: (_, element) => element.dataset.fromX || "0vw",
        y: (_, element) => element.dataset.fromY || "0vh",
        rotateX: -28,
        rotateY: 16,
      ...
      tl.add("syncStart")
        ...
        .to(
          ...
          {
            xPercent: window.innerWidth < 640 ? 0 : -18,
            duration: 1.2,
          },
          "syncStart+=0.08"
        )
  ...
  return (
    <div
      ref={containerRef}
      className="relative h-full w-full overflow-hidden min-h-[600px]"
    >
      {/* Background */}
      ...
      <div
        ref={imageLayerRef}
        className="absolute inset-0 will-change-transform pointer-events-none flex items-center justify-center"
      >
        <img
          ref={imageRef}
          src={homeHeroSection}
          alt="Finovate cinematic hero"
          className="ih-full w-full object-contain sm:object-cover"
        />
      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 flex items-center">
        <div
          ref={textBlockRef}
          className="max-w-xl w-full will-change-transform"
        >
          ...
          <div className="flex justify-start">
            <span
              ref={wordRef}
              className="text-4xl sm:text-6xl lg:text-8xl font-semibold text-[#192435] tracking-[0.08em] break-words"
            >
          ...
          <p className="text-base sm:text-lg lg:text-xl text-[#24344a] mb-8 mt-6 max-w-lg">
          ...
          <Link
            to="/solutions"
            className="
              group relative inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4
